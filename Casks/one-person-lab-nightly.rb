cask "one-person-lab-nightly" do
  version "26.7.15-nightly.29445296888.1"
  ...
  # version: 26.7.15-nightly.29445296888.1
  # manifest: https://github.com/gaofeng21cn/one-person-lab-app/releases/download/v26.7.15-nightly.29445296888.1/latest-arm64-mac.yml
